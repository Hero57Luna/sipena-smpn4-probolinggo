<!doctype html>
  ...
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="https://jlk.fib.unand.ac.id/templates/images/ojs_brand_white.png" />      
    <link rel="amphtml" href="https://{{brand}}coid.pages.dev/" />    
    <link rel="canonical" href="{{canonical}}" />
    <meta name="keywords" content="{{brand}}, login {{brand}}, daftar {{brand}}, situs {{brand}}, link alternatif {{brand}}, link situs {{brand}}">
    <meta property="og:site_name" content="{{brand}}" />
    <meta property="og:title" content="{{title}}" />
    <meta property="og:url" content="{{canonical}}" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="{{description}}" />
    <meta property="og:image" content="https://jlk.fib.unand.ac.id/public/journals/1/cover_issue_4_en_US.png" />
    ...
    <meta itemprop="thumbnailUrl" content="https://jlk.fib.unand.ac.id/public/journals/1/cover_issue_4_en_US.png" />
    <link rel="image_src" href="https://jlk.fib.unand.ac.id/public/journals/1/cover_issue_4_en_US.png" />
    <meta itemprop="image" content="https://jlk.fib.unand.ac.id/public/journals/1/cover_issue_4_en_US.png" />
    <meta name="twitter:wwwwwwwwwww" content="{{title}}" />
    <meta name="twitter:image" content="https://jlk.fib.unand.ac.id/public/journals/1/cover_issue_4_en_US.png" />
  ...
  .n-columns-2 {
    ...
    .login, .login-button {
      background: linear-gradient(to bottom, #771E24 0%, #771E24 100%);
              ...
              <div class="header-title-nav-wrapper">
                ...
                <div class="
                  ...
                  <div class="header-title-logo">
                    <a href="{{canonical}}" data-animation-role="header-element">
  
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://smkn1tapinselatan.sch.id/public/img/konfigurasi/logo/1698791633_debb763769c54f126d9a.png"
      ...
      '>
              <div class="content">
                ...
                <div class="n-columns-2">
                  <a href="https://{{brand}}.co.id/" rel="nofollow noreferrer" class="login">LOGIN</a>
                  <a href="https://{{brand}}.co.id/" rel="nofollow noreferrer" class="register">DAFTAR</a>
                  </div>
                  ...
                  <article
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link">{{title}}</a>
                      </div>
                        ...
                        <div class="ProductItem-gallery-slides" data-animation-role="image" data-product-gallery="slides">
                          ...
                          <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                            ...
                            <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                              ...
                              data-src="https://jlk.fib.unand.ac.id/public/journals/1/cover_issue_4_en_US.png"
                              data-image="https://jlk.fib.unand.ac.id/public/journals/1/cover_issue_4_en_US.png"
                              data-image-dimensions="840x480" data-image-focal-point="0.5,0.5" alt="{{brand}}"
  ...
  <small class="copyright__content"><a href="{{canonical}}" title="Daftar Slot Online">Copyright ©2024 {{brand}}</a></small>
      </footer>
