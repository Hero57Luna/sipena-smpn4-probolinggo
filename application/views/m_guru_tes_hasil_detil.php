...
<div class="page-inner">
  <input id="submit_all_url" type="hidden" value="<?php echo base_url(); ?>adm/submit_all/<?php echo $uri4; ?>">
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between mb-3">
          ...
          <div class="btn-toolbar">
            <a href="<?php echo base_url(); ?>adm/hasil_ujian_cetak/<?php echo $uri4; ?>" target="_blank"><button class="btn btn-xs btn-primary fw-bold mr-3"><i class="fa fa-print" aria-hidden="true"></i><span class="d-none d-md-block">Cetak Hasil</span></button></a>
            <a onclick=submit_all()><button class="btn btn-xs btn-primary fw-bold"><i class="far fa-paper-plane" aria-hidden="true"></i><span class="d-none d-md-block">Submit All</span></button></a>
          </div>
        </div>
